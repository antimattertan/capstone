...
public class TourActivity extends AppCompatActivity {
    ...
    private ArrayList<Tour> recyclerDatas;

    // Json 통해 불러와진 전체 데이터 리스트
    private ArrayList<Tour> datas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parser = new TourParser(TourActivity.this);
    ...
    private void initAdapter() {
        adapter = new TourAdapter(this, this.recyclerDatas);
