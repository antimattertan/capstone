...
public class sampleActivity extends AppCompatActivity
    ...
    public void addMarker(GoogleMap googleMap) {
        ...
        try {
            for (int i = 0; i < restaurant.length(); i++) {
                ...
                MyItem item = new MyItem(rest.getString("TITLE"), rest.getString("ADDR1"), rest.getString("CNTCT_TEL")
    ...
    GoogleMap.OnMarkerClickListener  markerClickListener= new GoogleMap.OnMarkerClickListener() {
        ...
        public boolean onMarkerClick(@NonNull Marker marker) {
            ...
            Toast.makeText(getApplicationContext(), "클릭: " + markerId, Toast.LENGTH_LONG).show();
